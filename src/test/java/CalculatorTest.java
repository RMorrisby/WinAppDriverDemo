...
public class CalculatorTest {
    ...
    public void Addition()
    {
        ...
        System.out.println("Addition test : display shows : " + _GetCalculatorResultText());
    ...
    public void Division()
    {
        ...
        CalculatorSession.findElementByName("Two").click();
        CalculatorSession.findElementByName("Equals").click();
        System.out.println("Division test : display shows : " + _GetCalculatorResultText());
    ...
    public void Multiplication()
    {
        ...
        CalculatorSession.findElementByName("Nine").click();
        CalculatorSession.findElementByName("Equals").click();
        System.out.println("Multiplication test : display shows : " + _GetCalculatorResultText());
    ...
    public void Subtraction()
    {
        ...
        CalculatorSession.findElementByName("Equals").click();
        System.out.println("Subtraction test : display shows : " + _GetCalculatorResultText());
